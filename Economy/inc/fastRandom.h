...
#define gm_r_znew (gm_r_bro=((gm_r_w<gm_r_z)|(!gm_r_z)),gm_r_z=36969*gm_r_z+(gm_r_z>>16)+gm_r_bro)
#define gm_r_wnew (gm_r_bro=((gm_r_z<gm_r_w)|(!gm_r_w)),gm_r_w=18000*gm_r_w+(gm_r_w>>16)+gm_r_bro)
