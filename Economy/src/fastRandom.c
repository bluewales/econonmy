...
unsigned long gm_r_z=362436069, gm_r_w=521288629, gm_r_jsr=123456789, gm_r_jcong=380116160;
unsigned long gm_r_a=224466889, gm_r_b=7584631, gm_r_t[256];
/* Use random seeds to reset z,w,jsr,jcong,a,b, and the table
t[256]*/

unsigned long gm_r_x=0,gm_r_y=0,gm_r_bro=0;
unsigned char gm_r_c=0;
...
void sfastRandom(unsigned long seed) {
	...
	unsigned long i1 = MWC();
	unsigned long i2 = MWC();
	unsigned long i3 = MWC();
	unsigned long i4 = MWC();
	unsigned long i5 = MWC();
	unsigned long i6 = MWC();
...
void settable(unsigned long i1,unsigned long i2,unsigned long i3,unsigned long i4,unsigned long i5,unsigned long i6) {
	gm_r_x=0;gm_r_y=0;gm_r_bro=0;gm_r_c=0;
	int i; gm_r_z=i1; gm_r_w=i2; gm_r_jsr=i3; gm_r_jcong=i4; gm_r_a=i5; gm_r_b=i6;
	for(i=0;i<256;i=i+1) gm_r_t[i]=KISS();
}
